...
fig.add_trace(
  go.Scatter3d(x=xorbit, y=yorbit,z=zorbit,mode="lines",line=dict(width=2, color="blue"))
)

#fig.add_trace(
#  go.Scatter3d(x=xorbit, y=yorbit,z=zorbit,mode="markers",marker=dict(color="red",size=10))
#)
